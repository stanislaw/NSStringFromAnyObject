#
#  Be sure to run `pod spec lint NSStringFromAnyObject.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of NSStringFromAnyObject in Markdown format.
  ...
  # s.authors          = { "Stanislaw Pankevich" => "s.pankevich@gmail.com", "other author" => "email@address.com" }
  # s.author           = 'Stanislaw Pankevich', 'other author'
  # s.social_media_url = "http://twitter.com/Stanislaw Pankevich"
